...
const EditRMAdvertising = () => {
  ...
  const getPage = async () => {
    try {
      const responseData = await AdminPageSetting.show("rm-advertising").json();
  ...
  return (
    <>
      <nav className="navbar navbar-expand-lg navbar-light bg-dark justify-content-between p-2">
        ...
        <h1 className="ms-2">Edit RM Advertising</h1>
      </nav>
      <main>
...
export default EditRMAdvertising;
